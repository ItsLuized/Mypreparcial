...
<html>
    ...
    <body>
        ...
        <div id="show-profesional" class="content scaffold-show" role="main">
            ...
            <f:display bean="profesional" />
            <g:form resource="${this.profesional}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.profesional}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
